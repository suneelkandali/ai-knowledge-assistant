...
> **A local, Ollama-powered Streamlit application** that demonstrates four key AI patterns in one unified interface: conversational chat, prompt engineering, RAG (Retrieval-Augmented Generation) over PDFs, and a multi-agent research workflow.
...
- **`OLLAMA_CHAT_MODEL`** — Model used for chat, prompts, and agents (default: `gemma3:4b`)
